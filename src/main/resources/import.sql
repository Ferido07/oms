...
ተሽከርካሪን ለአገልግሎት ሳይከፍት በመናኸሪያ ውስጥ ከሁለት ሰዓት በላይ አቁሞ የሄደ', 1, 'DRIVER'),
  ...
  (11,'Vehicle Owner', 2, 2000, 1, 'ከመደበኛ  የሕዝብ  ትራንስፖርት  አገልግሎት  መስጫ  መናኸሪያ  ውጪ  ሲሠራ  ከተገኘ', 1, 'VEHICLE_OWNER');
...
VALUES
  ...
  (3, 'VEHICLE_OWNER', NOW(), 'Ferid', 0, NULL, NULL, NULL),
  (4, 'ASSOCIATION', NOW(), 'Ferid', 0, NULL, NULL, NULL);
